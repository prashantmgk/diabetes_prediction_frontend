...
const PregnancyFormPage = () => {
   ...
   return (
      <div className='h-full w-full relative'>
         ...
         <div className='ml-28'>
            <h3 className=' mt-10 font-semibold text-2xl text-[#070707]'>Total Pregnancies.</h3>
            <form onSubmit={handleSubmit}>
               <input value={pregnancy} onChange={(e) => setPregnancy(e.target.value)}  type="number" className=" mt-10 bg-gray-50 border-blue-600 border-[2px] text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-600 block w-[200px]  p-4 rounded-lg" name='name' placeholder="Enter Pregnanices" required/>
