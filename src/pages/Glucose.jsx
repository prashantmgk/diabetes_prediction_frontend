   ...
   return (
      ...
      <div className='h-full w-full relative'>
         ...
         <div className='w-full h-24 bg-blue-700 text-white flex items-center justify-between px-24'>
            <h1 className='text-[25px] font-mono'>What is your glucose levels? Please enter the value.</h1>
            <div className='w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center text-[40px]'>
               <p className='font-bold'>2</p>
            </div>
         </div>
         <div className='ml-28'>
            <h3 className=' mt-10 font-semibold text-2xl text-[#070707]'>Input Glucose level</h3>
            <form onSubmit={handleSubmit}>
               <input value={glucose} onChange={(e) => setGlucose(e.target.value)} type="number" className=" mt-10 bg-gray-50 border-blue-600 border-[2px] text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-600 block w-[200px]  p-4 rounded-lg" placeholder="Glucose level" required/>
